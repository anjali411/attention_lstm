...
print("Percentage of existing words: ",existing_words/_e, "\nPercentage of existing aspect words: ",existing_aspect_words/_a)
...
pickle.dump(train_input, open('neut_neg_pos_train_input.pkl', 'wb'))
